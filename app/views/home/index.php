            ...
            <div class="home_slider_container">
                ...
                <div class="owl-carousel owl-theme home_slider">
                    ...
                    <div class="owl-item">
                        ...
                        <div class="home_slider_background" style="background-image:url(<?=self::RES?>/images/index.jpg)"></div>
                        <div class="home_container">
                            <div class="container">
                                <div class="row">
                                    <div class="col">
                                        <div class="home_content text-center">
                                            <div class="home_logo"><img src="<?=self::RES?>/images/home_logo.png" alt=""></div>
                                            <div class="home_text">
                        ...
                        <div class="featured_container">
                            <div class="row">
                                <div class="col-lg-6 featured_col">
                                    <div class="featured_content">
                                        ...
                                        <div class="featured_footer d-flex align-items-center justify-content-start">
                                            <div class="featured_author_image"><img src="<?=self::RES?>/images/featured_author.jpg" alt=""></div>
                                ...
                                <div class="col-lg-6 featured_col">
                                    ...
                                    <div class="featured_background" style="background-image:url(<?=self::RES?>/images/featured.jpg)"></div>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col">
                        ...
                        <div class="courses_slider_container">
                            <div class="owl-carousel owl-theme courses_slider">
                                ...
                                <div class="owl-item">
                                    <div class="course">
                                        <div class="course_image"><img src="<?=self::RES?>/images/course_1.jpg" alt=""></div>
                                        <div class="course_body">
                                            ...
                                            <div class="course_footer d-flex align-items-center justify-content-start">
                                                <div class="course_author_image"><img src="<?=self::RES?>/images/featured_author.jpg" alt="https://unsplash.com/@anthonytran"></div>
                                ...
                                <div class="owl-item">
                                    <div class="course">
                                        <div class="course_image"><img src="<?=self::RES?>/images/course_2.jpg" alt=""></div>
                                        <div class="course_body">
                                            <div class="course_header d-flex flex-row align-items-center justify-content-start">
                                            ...
                                            <div class="course_text">Maecenas rutrum viverra sapien sed ferm entum. Morbi tempor odio eget lacus tempus pulvinar.</div>
                                            <div class="course_footer d-flex align-items-center justify-content-start">
                                                <div class="course_author_image"><img src="<?=self::RES?>/images/course_author_2.jpg" alt=""></div>
                                ...
                                <div class="owl-item">
                                    <div class="course">
                                        <div class="course_image"><img src="<?=self::RES?>/images/course_3.jpg" alt="https://unsplash.com/@annademy"></div>
                                        <div class="course_body">
                                            <div class="course_header d-flex flex-row align-items-center justify-content-start">
                                                <div class="course_tag"><a href="#">Featured</a></div>
                                                <div class="course_price ml-auto">Price: <span>$35</span></div>
                                            ...
                                            <div class="course_text">Maecenas rutrum viverra sapien sed ferm entum. Morbi tempor odio eget lacus tempus pulvinar.</div>
                                            <div class="course_footer d-flex align-items-center justify-content-start">
                                                <div class="course_author_image"><img src="<?=self::RES?>/images/course_author_3.jpg" alt=""></div>
        ...
        <div class="milestones">
            ...
            <div class="parallax_background parallax-window" data-parallax="scroll" data-image-src="<?=self::RES?>/images/milestones.jpg" data-speed="0.8"></div>
            <div class="container">
                <div class="row milestones_container">
                    ...
                    <div class="col-lg-3 milestone_col">
                        <div class="milestone text-center">
                            <div class="milestone_icon"><img src="<?=self::RES?>/images/milestone_1.svg" alt=""></div>
                    ...
                    <div class="col-lg-3 milestone_col">
                        <div class="milestone text-center">
                            <div class="milestone_icon"><img src="<?=self::RES?>/images/milestone_2.svg" alt=""></div>
                    ...
                    <div class="col-lg-3 milestone_col">
                        <div class="milestone text-center">
                            <div class="milestone_icon"><img src="<?=self::RES?>/images/milestone_3.svg" alt=""></div>
                    ...
                    <div class="col-lg-3 milestone_col">
                        <div class="milestone text-center">
                            <div class="milestone_icon"><img src="<?=self::RES?>/images/milestone_4.svg" alt=""></div>
                    ...
                    <div class="col-lg-4 grouped_col">
                        ...
                        <div class="news">
                            ...
                            <div class="news_post d-flex flex-row align-items-start justify-content-start">
                                <div><div class="news_post_image"><img src="<?=self::RES?>/images/news_1.jpg" alt="https://unsplash.com/@beccatapert"></div></div>
                            ...
                            <!-- News Post -->
                            <div class="news_post d-flex flex-row align-items-start justify-content-start">
                                <div><div class="news_post_image"><img src="<?=self::RES?>/images/news_2.jpg" alt="https://unsplash.com/@nbb_photos"></div></div>
                                <div class="news_post_body">
                                    <div class="news_post_date">April 02, 2018</div>
                            ...
                            <!-- News Post -->
                            <div class="news_post d-flex flex-row align-items-start justify-content-start">
                                <div><div class="news_post_image"><img src="<?=self::RES?>/images/news_3.jpg" alt="https://unsplash.com/@rawpixel"></div></div>
                                <div class="news_post_body">
                                    <div class="news_post_date">April 02, 2018</div>
                                    <div class="news_post_title"><a href="news.html">Why Choose online education?</a></div>
                                    <div class="news_post_author">By <a href="#">William Smith</a></div>
                            ...
                            <!-- News Post -->
                            <div class="news_post d-flex flex-row align-items-start justify-content-start">
                                <div><div class="news_post_image"><img src="<?=self::RES?>/images/news_4.jpg" alt="https://unsplash.com/@jtylernix"></div></div>
                                <div class="news_post_body">
                                    <div class="news_post_date">April 02, 2018</div>
                                    <div class="news_post_title"><a href="news.html">Books, Kindle or tablet?</a></div>
                                    <div class="news_post_author">By <a href="#">William Smith</a></div>
                    ...
                    <div class="col">
                        <div class="video_container_outer">
                            <div class="video_container">
                                ...
                                <video id="vid1" class="video-js vjs-default-skin" controls data-setup='{ "poster": "<?=self::RES?>/images/video.jpg", "techOrder": ["youtube"], "sources": [{ "type": "video/youtube", "src": "https://youtu.be/5_MRXyYjHDk"}], "youtube": { "iv_load_policy": 1 } }'>
                                </video>
                            </div>
                        </div>
                    </div>
